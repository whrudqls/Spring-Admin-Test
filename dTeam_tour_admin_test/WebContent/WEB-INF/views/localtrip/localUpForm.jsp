...
<div class="container">
<h3>국내여행등록</h3>
	<form action="localUpProcess" method="post" enctype="multipart/form-data" id="localupform">
		<div class="form-group">
			<label for="larea">larea</label> <input type="text" class="form-control"
				id="larea" placeholder="larea 입력" name="larea">
		</div>
		<div class="form-group">
			<label for="ltitle">ltitle</label> <input type="text" class="form-control"
				id="ltitle" placeholder="ltitle 입력" name="ltitle">
		</div>
		<div class="form-group">
			<label for="lcontent">lcontent</label> <input type="text"
				class="form-control" id="lcontent" placeholder="lcontent 입력" name="lcontent">
		</div>
		<div class="row mb-3">
...
<!--  
	...
	-->	
		<div class="form-group">
			<label for="lprice">lprice</label> <input type="number" class="form-control"
				id="lprice" placeholder="lprice 입력" name="lprice"
				required="required">
		</div>
<!--		
		<div class="form-group">
